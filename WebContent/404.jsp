...
<div class="container-fluid">
	...
	<div class="row" style="background-image: url(images/texture-bw.png)"> 
		...
		<br/><br/>
		<form>
		<center>	<button type="button" class="buterr" value="home"><i class="fas fa-home"></i>HOME</button>
			<button type="button" class="buterr" value="report" onClick="ReportMail.java"><i class="fas fa-bug"></i>REPORT</button></center>
